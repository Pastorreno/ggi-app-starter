      ...
      <section className="mx-auto max-w-6xl px-6 py-10 sm:py-16">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <a href="#interactive" className="rounded-full bg-cyan-400 px-7 py-3 font-bold text-slate-950 shadow-sm hover:bg-cyan-300">Try the Interactive Demo</a>
            <Link href="/contact" className="rounded-full border border-white/15 bg-white/[0.06] px-7 py-3 font-semibold text-white hover:border-cyan-300">Start a Project</Link>
          </div>
        </div>
